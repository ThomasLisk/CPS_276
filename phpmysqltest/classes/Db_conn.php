...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'tliskiewicz';//this will be your WCC username
      $dbUsr = 'tliskiewicz';//this will be your WCC username
      $dbPass = 'zwuDBSKUDKjQ';//this will be the password found in the video.
